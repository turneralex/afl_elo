...
results <- get_match_results() %>% 
    filter(year(Date) %in% 2014:2018 & Round %in% map_chr(1:23, ~ paste0("R", .))) %>% 
...
sos_hist <- results %>% 
    ...
    labs(title = "AFL Home Team Share of Scoring Histogram",
         subtitle = "The share of total points for every home team 2014-2018 inclusive",
         x = "Share of Scoring",
         y = "Frequency")
...
margin_hist <- results %>% 
    ...
    labs(title = "AFL Home Team Margin Histogram",
         subtitle = "The margin for every home team 2014-2018 inclusive",
         x = "Margin",
         y = "Frequency")
